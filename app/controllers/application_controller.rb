  ...
  before_action :configure_permitted_parameters, if: :devise_controller?
	...
	def configure_permitted_parameters
		if resource_class == User
   			...
   			devise_parameter_sanitizer.permit(:account_update,keys:[:name,:age,:email,:job,:image])
		    ...
		    devise_parameter_sanitizer.permit(:sign_up, keys: [:salon_name,:email,:person_name,:number,:price,:purpose])
   			devise_parameter_sanitizer.permit(:sign_in,keys:[:email])
   			devise_parameter_sanitizer.permit(:account_update,keys:[:salon_name,:email,:person_name,:number,:price,:purpose,:image])
    else
    		super
    end
  end
